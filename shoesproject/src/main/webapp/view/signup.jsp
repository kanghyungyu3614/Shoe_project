...
<form class="lsignup" action="/shoesproject/shoe/signup" method="post">
	...
	<table>
		<tr class="oneline">
			<td class="cocl2"><input type="text" placeholder="이름" name="lname" id="lname" class="inputsize"></td>
			<td class="cocl3"></td>
	
		</tr>
		<tr class="oneline">
			
			<td class="cocl2"><input type="text" placeholder="아이디" name="lid" id="lid" onkeyup="log1()" class="inputsize"></td>
			<td class="cocl3"></td>
		</tr>
		<tr class="oneline">
			<td class="cocl2"><input type="text" placeholder="비밀번호" name="lpw" id="lpw" onkeyup="log2()" class="inputsize"></td>
			<td class="cocl3"></td>
			
		</tr>
		<tr class="oneline">
			<td class="cocl2"><input type="text" placeholder="전화번호" name="lph" id="lph" onkeyup="log3()" class="inputsize"></td>
			<td class="cocl3"></td>
			
		</tr>
		<tr class="oneline">
			<td class="cocl2"><input type="text" placeholder="이메일" name="lemail" id="lemail" onkeyup="log4()" class="inputsize"></td>
			<td class="cocl3"></td>
		</tr>
		<tr class="oneline">
			<td class="cocl2"> <input type="text" placeholder="발사이즈"  name="lsize" id="lsize" onkeyup="log5()" class="inputsize"></td>
			<td class="cocl3"></td>
		</tr>
