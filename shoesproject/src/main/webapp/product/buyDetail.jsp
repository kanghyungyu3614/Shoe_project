...
<link href="../css/buyDetail.css" rel="stylesheet">
</head>
<body>
<%@include file="../main/mainbaner.jsp" %>
<div id="main">
	<div class="maintitle">구매하기</div>
	...
	<div class="subproduct">
		...
		<div id="size_245" class="product_size"	onclick="buyAddButton(245)">
			<div>245</div>
			<div>구매입찰</div>
		</div>
		...
		<div id="size_300" class="product_size"	onclick="buyAddButton(300)">
			<div>300</div>
			<div>구매입찰</div>
		</div>
...
<script type="text/javascript" src="../js/buyDetail.js"></script>
</body>
</html>